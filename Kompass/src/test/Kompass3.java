...
public class Kompass3 implements MultiAxisGyro {
	...
	public Kompass3(I2CBus bus) throws IOException {
	...
	public static void main(String[] args) throws Exception {
		...
		Kompass3 hmc5883l = new Kompass3(bus);
		...
		while (System.currentTimeMillis() - now < 100000) {
			...
			try {
				double heading = Math.toDegrees(Math.atan2(Double.parseDouble(sy), Double.parseDouble(sx)));
				System.out.println("Winkel: " + heading);
