...
public class EchoClass {
	...
	private EchoClass(Pin echoPin, Pin trigPin) {
	...
	public static void main(String[] args) {
		Pin echoPin = RaspiPin.GPIO_08; // PIN 3
		Pin trigPin = RaspiPin.GPIO_09; // PIN 5
		EchoClass monitor = new EchoClass(echoPin, trigPin);
